...
for i in range(len(zpos)):
    if i==4 or i==8:
        Bnew = (tsp*h/6)+(tsk*sqrt((ypos[4]-ypos[3])**2+(zpos[4]-zpos[3])**2)/6)*(2+ypos[3]/ypos[4])+(tsk*(phi-sqrt((ypos[4]-ypos[3])**2+(zpos[4]-zpos[3])**2))/6)*(2+ypos[5]/ypos[4])
        B.append(Bnew)
    elif i==6:
        B.append(Astiff)
    elif i==5 or i==7:
        Bnew = Astiff+(tsk*sqrt((ypos[5]-ypos[4])**2+(zpos[5]-zpos[4])**2)/6)*(2+ypos[4]/ypos[5])+(tsk*2*phi/6)
        B.append(Bnew)
    elif i==3 or i==9:
        Bnew = Astiff+(tsk*sqrt((ypos[4]-ypos[3])**2+(zpos[4]-zpos[3])**2)/6)*(2+ypos[4]/ypos[3])+(tsk*phi/6)*(2+ypos[2]/ypos[3])
        B.append(Bnew)
    elif i==0 or i==12:
        Bnew = Astiff + (tsk*phi/6)*(2+ypos[12]/ypos[0]) + (tsk*phi/6)*(2+ypos[1]/ypos[0])
        B.append(Bnew)
    elif i==1 or i==11:
        Bnew = Astiff + (tsk*phi/6)*(2+ypos[0]/ypos[1]) + (tsk*phi/6)*(2+ypos[2]/ypos[1])
        B.append(Bnew)
    elif i==2 or i==10:
        Bnew = Astiff + (tsk*phi/6)*(2+ypos[1]/ypos[2]) + (tsk*phi/6)*(2+ypos[3]/ypos[2])
        B.append(Bnew)
